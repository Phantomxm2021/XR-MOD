...
{
    public class InitUIMonoBehaviourAdaptor : BaseInitCommandAdapter<UIMonoBehaviourAdaptor.Adapter>
    {
        ...
        public override UIMonoBehaviourAdaptor.Adapter Execute()
        {
            var tmp_Adapter = GameObject.AddComponent<UIMonoBehaviourAdaptor.Adapter>();
