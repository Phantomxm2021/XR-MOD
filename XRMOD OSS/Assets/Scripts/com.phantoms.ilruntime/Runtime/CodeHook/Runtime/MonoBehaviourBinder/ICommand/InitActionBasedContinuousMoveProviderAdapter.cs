...
{
    public class
        InitActionBasedContinuousMoveProviderAdapter : BaseInitCommandAdapter<
            ActionBasedContinuousMoveProviderAdapter.Adapter>
    {
        public InitActionBasedContinuousMoveProviderAdapter(GameObject _gameObject, ILTypeInstance _instance,
            MonoData _monoData,
            IType _iLType) : base(_gameObject, _instance, _monoData, _iLType)
        {
        }

        public override ActionBasedContinuousMoveProviderAdapter.Adapter Execute()
        {
            var tmp_XRBaseInteractableAdapter =
                GameObject.AddComponent<ActionBasedContinuousMoveProviderAdapter.Adapter>();
