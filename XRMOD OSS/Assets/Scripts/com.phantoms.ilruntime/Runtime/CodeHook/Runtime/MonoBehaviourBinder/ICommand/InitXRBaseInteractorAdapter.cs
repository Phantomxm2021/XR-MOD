...
{
    public class InitXRBaseInteractorAdapter : BaseInitCommandAdapter<XRBaseInteractorAdapter.Adapter>
    {
        public InitXRBaseInteractorAdapter(GameObject _gameObject, ILTypeInstance _instance, MonoData _monoData,
            IType _iLType) : base(_gameObject, _instance, _monoData, _iLType)
        {
        }

        public override XRBaseInteractorAdapter.Adapter Execute()
        {
            var tmp_XRBaseInteractableAdapter = GameObject.AddComponent<XRBaseInteractorAdapter.Adapter>();
