...
{
    public class InitConstrainedMoveProviderAdapter : BaseInitCommandAdapter<ConstrainedMoveProviderAdapter.Adapter>
    {
        public InitConstrainedMoveProviderAdapter(GameObject _gameObject, ILTypeInstance _instance, MonoData _monoData,
            IType _iLType) : base(_gameObject, _instance, _monoData, _iLType)
        {
        }

        public override ConstrainedMoveProviderAdapter.Adapter Execute()
        {
            var tmp_XRBaseInteractableAdapter = GameObject.AddComponent<ConstrainedMoveProviderAdapter.Adapter>();
