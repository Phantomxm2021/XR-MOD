...
{
    public class InitDeviceBasedContinuousTurnProviderAdapter: BaseInitCommandAdapter<DeviceBasedContinuousTurnProviderAdapter.Adapter>
    {
        public InitDeviceBasedContinuousTurnProviderAdapter(GameObject _gameObject, ILTypeInstance _instance, MonoData _monoData,
            IType _iLType) : base(_gameObject, _instance, _monoData, _iLType)
        {
        }

        public override DeviceBasedContinuousTurnProviderAdapter.Adapter Execute()
        {
            var tmp_XRBaseInteractableAdapter = GameObject.AddComponent<DeviceBasedContinuousTurnProviderAdapter.Adapter>();
