...
{
    public class InitDeviceBasedContinuousMoveProviderAdapter: BaseInitCommandAdapter<DeviceBasedContinuousMoveProviderAdapter.Adapter>
    {
        public InitDeviceBasedContinuousMoveProviderAdapter(GameObject _gameObject, ILTypeInstance _instance, MonoData _monoData,
            IType _iLType) : base(_gameObject, _instance, _monoData, _iLType)
        {
        }

        public override DeviceBasedContinuousMoveProviderAdapter.Adapter Execute()
        {
            var tmp_XRBaseInteractableAdapter = GameObject.AddComponent<DeviceBasedContinuousMoveProviderAdapter.Adapter>();
