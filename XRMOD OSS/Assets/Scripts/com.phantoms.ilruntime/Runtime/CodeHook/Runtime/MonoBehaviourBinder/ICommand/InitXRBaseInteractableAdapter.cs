...
{
    public class InitXRBaseInteractableAdapter : BaseInitCommandAdapter<XRBaseInteractableAdapter.Adapter>
    {
        public override XRBaseInteractableAdapter.Adapter Execute()
        {
            var tmp_XRBaseInteractableAdapter = GameObject.AddComponent<XRBaseInteractableAdapter.Adapter>();
        ...
        public InitXRBaseInteractableAdapter(GameObject _gameObject, ILTypeInstance _instance, MonoData _monoData,
