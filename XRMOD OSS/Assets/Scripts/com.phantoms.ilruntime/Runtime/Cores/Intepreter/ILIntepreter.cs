                                    ...
                                    else
                                    {
                                        ...
                                        if (obj != null)
                                        {
                                            if (obj is ILTypeInstance)
                                            {
                                                ...
                                                {
                                                    throw new InvalidCastException(
                                                        string.Format("Cannot Cast {0} to {1}",
                                                            ((ILTypeInstance) obj).Type.FullName, type.FullName));
                                                }
                                            }
                                            else
                                            {
                    ...
                    catch (Exception ex)
                    {
                        if (ehs != null)
                        {
                            ...
                            if (eh != null)
                            {
                                unhandledException = false;
                                finallyEndAddress = -1;
                                lastCaughtEx = ex is ILRuntimeException
                                    ? ex
                                    : new ILRuntimeException(ex.Message, this, method, ex);
                                ip = ptr + eh.HandlerStart;
                                continue;
                            }
                        }
