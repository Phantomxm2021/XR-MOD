...
{   
    public class ActionBasedContinuousMoveProviderAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(UnityEngine.XR.Interaction.Toolkit.ActionBasedContinuousMoveProvider);
            }
        }
        ...
        public class Adapter : UnityEngine.XR.Interaction.Toolkit.ActionBasedContinuousMoveProvider, CrossBindingAdaptorType
        {
