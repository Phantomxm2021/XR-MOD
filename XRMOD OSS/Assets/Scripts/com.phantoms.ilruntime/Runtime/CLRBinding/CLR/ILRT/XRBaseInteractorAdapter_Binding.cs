...
{
    unsafe class XRBaseInteractorAdapter_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ILRuntime.CLRBinding.Adapter.XRBaseInteractorAdapter);
            args = new Type[]{};
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new ILRuntime.CLRBinding.Adapter.XRBaseInteractorAdapter());
            app.RegisterCLRCreateArrayInstance(type, s => new ILRuntime.CLRBinding.Adapter.XRBaseInteractorAdapter[s]);
        ...
        static StackObject* get_BaseCLRType_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ILRuntime.CLRBinding.Adapter.XRBaseInteractorAdapter instance_of_this_method = (ILRuntime.CLRBinding.Adapter.XRBaseInteractorAdapter)typeof(ILRuntime.CLRBinding.Adapter.XRBaseInteractorAdapter).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new ILRuntime.CLRBinding.Adapter.XRBaseInteractorAdapter();
