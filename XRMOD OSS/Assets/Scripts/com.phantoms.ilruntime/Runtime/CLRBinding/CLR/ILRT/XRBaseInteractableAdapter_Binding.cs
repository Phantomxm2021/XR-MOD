...
{
    unsafe class XRBaseInteractableAdapter_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ILRuntime.CLRBinding.Adapter.XRBaseInteractableAdapter);
            args = new Type[]{};
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new ILRuntime.CLRBinding.Adapter.XRBaseInteractableAdapter());
            app.RegisterCLRCreateArrayInstance(type, s => new ILRuntime.CLRBinding.Adapter.XRBaseInteractableAdapter[s]);
        ...
        static StackObject* get_BaseCLRType_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ILRuntime.CLRBinding.Adapter.XRBaseInteractableAdapter instance_of_this_method = (ILRuntime.CLRBinding.Adapter.XRBaseInteractableAdapter)typeof(ILRuntime.CLRBinding.Adapter.XRBaseInteractableAdapter).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new ILRuntime.CLRBinding.Adapter.XRBaseInteractableAdapter();
