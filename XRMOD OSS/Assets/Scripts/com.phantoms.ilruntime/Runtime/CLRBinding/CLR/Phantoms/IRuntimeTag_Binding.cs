...
{
    unsafe class IRuntimeTag_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(com.Phantoms.ARMODAPI.Runtime.IRuntimeTag);
            args = new Type[]{typeof(System.String)};
            method = type.GetMethod("DoCompareTag", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, DoCompareTag_0);

            app.RegisterCLRCreateArrayInstance(type, s => new com.Phantoms.ARMODAPI.Runtime.IRuntimeTag[s]);
        ...
        static StackObject* DoCompareTag_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            com.Phantoms.ARMODAPI.Runtime.IRuntimeTag instance_of_this_method = (com.Phantoms.ARMODAPI.Runtime.IRuntimeTag)typeof(com.Phantoms.ARMODAPI.Runtime.IRuntimeTag).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
