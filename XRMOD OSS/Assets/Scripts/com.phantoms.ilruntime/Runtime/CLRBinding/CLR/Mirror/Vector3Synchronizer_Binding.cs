...
{
    unsafe class Vector3Synchronizer_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(com.PhantomsXR.MirrorExtension.Runtime.Vector3Synchronizer);
            args = new Type[]{};
            ...
            args = new Type[]{typeof(UnityEngine.Vector3), typeof(Mirror.NetworkIdentity)};
            ...
            args = new Type[]{typeof(System.Action<UnityEngine.Vector3, Mirror.NetworkIdentity>)};
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new com.PhantomsXR.MirrorExtension.Runtime.Vector3Synchronizer());
            app.RegisterCLRCreateArrayInstance(type, s => new com.PhantomsXR.MirrorExtension.Runtime.Vector3Synchronizer[s]);
        ...
        static StackObject* get_GetSynchronousValue_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            com.PhantomsXR.MirrorExtension.Runtime.Vector3Synchronizer instance_of_this_method = (com.PhantomsXR.MirrorExtension.Runtime.Vector3Synchronizer)typeof(com.PhantomsXR.MirrorExtension.Runtime.Vector3Synchronizer).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        static StackObject* CmdModifyValue_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.Vector3 @_vector3 = (UnityEngine.Vector3)typeof(UnityEngine.Vector3).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)16);
            __intp.Free(ptr_of_this_method);
            ...
            instance_of_this_method.CmdModifyValue(@_vector3, @_sender);
        ...
        static StackObject* RpcSynchronizingValue_2(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            UnityEngine.Vector3 @_syncedValue = (UnityEngine.Vector3)typeof(UnityEngine.Vector3).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)16);
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* RegisterValueSyncedCallback_3(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            System.Action<UnityEngine.Vector3, Mirror.NetworkIdentity> @_callback = (System.Action<UnityEngine.Vector3, Mirror.NetworkIdentity>)typeof(System.Action<UnityEngine.Vector3, Mirror.NetworkIdentity>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)8);
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new com.PhantomsXR.MirrorExtension.Runtime.Vector3Synchronizer();
