...
{
    unsafe class DeviceBasedContinuousTurnProvider_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UnityEngine.XR.Interaction.Toolkit.DeviceBasedContinuousTurnProvider);
            args = new Type[]{};
            method = type.GetMethod("get_inputBinding", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_inputBinding_0);
            args = new Type[]{typeof(UnityEngine.XR.Interaction.Toolkit.DeviceBasedContinuousTurnProvider.InputAxes)};
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new UnityEngine.XR.Interaction.Toolkit.DeviceBasedContinuousTurnProvider());
            app.RegisterCLRCreateArrayInstance(type, s => new UnityEngine.XR.Interaction.Toolkit.DeviceBasedContinuousTurnProvider[s]);
        ...
        static StackObject* set_inputBinding_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            UnityEngine.XR.Interaction.Toolkit.DeviceBasedContinuousTurnProvider.InputAxes @value = (UnityEngine.XR.Interaction.Toolkit.DeviceBasedContinuousTurnProvider.InputAxes)typeof(UnityEngine.XR.Interaction.Toolkit.DeviceBasedContinuousTurnProvider.InputAxes).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)20);
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new UnityEngine.XR.Interaction.Toolkit.DeviceBasedContinuousTurnProvider();
