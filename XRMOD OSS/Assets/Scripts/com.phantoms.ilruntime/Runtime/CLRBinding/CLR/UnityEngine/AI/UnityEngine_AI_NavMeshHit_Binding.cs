...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_AI_NavMeshHit_Binding
    {
        ...
        static StackObject* get_position_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.GetObjectAndResolveReference(ptr_of_this_method);
            UnityEngine.AI.NavMeshHit instance_of_this_method = (UnityEngine.AI.NavMeshHit)typeof(UnityEngine.AI.NavMeshHit).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
