...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_AI_NavMesh_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, SamplePosition_0);


        }


        static StackObject* SamplePosition_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.AI.NavMeshHit @hit = (UnityEngine.AI.NavMeshHit)typeof(UnityEngine.AI.NavMeshHit).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack));
