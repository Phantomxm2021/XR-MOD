...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_AI_NavMeshAgent_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, SetDestination_1);
            args = new Type[]{};
            method = type.GetMethod("get_hasPath", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_hasPath_2);
            args = new Type[]{};
            method = type.GetMethod("get_pathStatus", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_pathStatus_3);
            args = new Type[]{};
            method = type.GetMethod("ResetPath", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, ResetPath_4);
        ...
        static StackObject* SetDestination_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
        ...
        static StackObject* get_hasPath_2(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* get_pathStatus_3(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* ResetPath_4(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
