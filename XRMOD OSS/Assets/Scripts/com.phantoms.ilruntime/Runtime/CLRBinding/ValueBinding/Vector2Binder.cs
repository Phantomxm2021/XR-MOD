...
public unsafe class Vector2Binder : ValueTypeBinder<Vector2>
{
    ...
    public override unsafe void AssignFromStack(ref Vector2 ins, StackObject* ptr, AutoList mStack)
    {
    ...
    public override unsafe void CopyValueTypeToStack(ref Vector2 ins, StackObject* ptr, AutoList mStack)
    {
        var v = ILIntepreter.Minus(ptr, 1);
        *(float*)&v->Value = ins.x;
        v = ILIntepreter.Minus(ptr, 2);
