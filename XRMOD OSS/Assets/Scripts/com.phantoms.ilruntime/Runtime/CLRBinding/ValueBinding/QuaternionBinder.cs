...
public unsafe class QuaternionBinder : ValueTypeBinder<Quaternion>
{
    ...
    public override unsafe void AssignFromStack(ref Quaternion ins, StackObject* ptr, AutoList mStack)
    {
    ...
    public override unsafe void CopyValueTypeToStack(ref Quaternion ins, StackObject* ptr, AutoList mStack)
    {
        var v = ILIntepreter.Minus(ptr, 1);
        *(float*)&v->Value = ins.w;
        v = ILIntepreter.Minus(ptr, 2);
