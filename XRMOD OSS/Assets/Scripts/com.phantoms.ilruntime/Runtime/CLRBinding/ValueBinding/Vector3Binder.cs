...
{
    public override unsafe void AssignFromStack(ref Vector3 ins, StackObject* ptr, AutoList mStack)
    {
    ...
    public override unsafe void CopyValueTypeToStack(ref Vector3 ins, StackObject* ptr, AutoList mStack)
    {
        var v = ILIntepreter.Minus(ptr, 1);
        *(float*)&v->Value = ins.x;
        v = ILIntepreter.Minus(ptr, 2);
