...
namespace GLTFast.Materials
{
    ...
    public class ShaderGraphMaterialGenerator : MaterialGenerator
    {
        ...
        protected const string
            SHADER_PATH_PREFIX =
                "Assets/Scripts/ThirdParties/glTFast/Runtime/Shader/"; //"Packages/com.atteneder.gltfast/Runtime/Shader/";
#else
        ...
        static readonly int
            baseMapScaleTransformPropId = Shader.PropertyToID("baseColorTexture_ST"); //TODO: support in shader!

        static readonly int
            baseMapRotationPropId = Shader.PropertyToID("baseColorTexture_Rotation"); //TODO; support in shader!

        static readonly int
            baseMapUVChannelPropId = Shader.PropertyToID("baseColorTexture_texCoord"); //TODO; support in shader!
        ...
        protected static readonly int transmissionTextureScaleTransformPropId =
            Shader.PropertyToID("transmissionTexture_texCoord");

        protected static readonly int transmissionTextureRotationPropId =
            Shader.PropertyToID("transmissionTexture_Rotation");

        protected static readonly int transmissionTextureUVChannelPropId =
            Shader.PropertyToID("transmissionTexture_texCoord");
...
#if !UNITY_SHADER_GRAPH_12_OR_NEWER
        static Dictionary<MetallicShaderFeatures,Shader> metallicShaders =
 new Dictionary<MetallicShaderFeatures,Shader>();
        static Dictionary<SpecularShaderFeatures,Shader> specularShaders =
 new Dictionary<SpecularShaderFeatures,Shader>();
        ...
        protected virtual ShaderMode? ApplyTransmissionShaderFeatures(Schema.Material gltfMaterial)
        {
            ...
            Color baseColorLinear = Color.white;
            var premul = TransmissionWorkaroundShaderMode(gltfMaterial.extensions.KHR_materials_transmission,
                ref baseColorLinear);
