...
namespace com.PhantomsXR.VisualScriptingExtension.Runtime
{
    [UnitCategory("ARMOD/NotificationData"), 
     UnitShortTitle("Create Open BuiltIn Browser Data"),
     UnitTitle("Create Open BuiltIn Browser Data")]
    [TypeIcon(typeof(AxisEventData))]

    public class VSOpenBuiltInData : VSBaseData
    {
        [DoNotSerialize] public ValueInput URL;
        ...
        protected override void Definition()
        {
            ...
            Data = ValueInput<string>(nameof(Data));
            base.Definition();
        }

        protected override BaseNotificationData CreateData(Flow _arg)
        {
            var tmp_NotificationData = new OpenBuiltInNotificationData()
            {
                ...
                Url = _arg.GetValue<string>(URL),
                Data = _arg.GetValue<string>(Data),
            };
