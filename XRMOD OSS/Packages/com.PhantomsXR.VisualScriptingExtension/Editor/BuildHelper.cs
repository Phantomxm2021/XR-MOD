//Copy from https://github.com/RealityStop/Bolt.Addons.Community/blob/UVSsupport-Dev/Editor/BuildHelper.cs
...
namespace com.PhantomsXR.VisualScriptingExtension.Runtime.Editor
{
    ...
    public class PackagesLinkXmlExtractor : IPreprocessBuildWithReport, IPostprocessBuildWithReport
    {
        ...
        public static async Task CreateMergedLinkFromPackages()
        {
            ...
            if (request.Status == StatusCode.Success)
            {
                ...
                foreach (PackageInfo package in request.Result)
                {
                    ...
                    xmlPathList.AddRange(Directory.EnumerateFiles(path, "linkmerge.xml", SearchOption.AllDirectories)
                        .ToList());
                }
