...
{
    [Descriptor(typeof(SetPlayerNameUnit))]
    public class SetPlayerNameUnitDescriptor : ARMODBaseUnitDescriptor
    {
        public SetPlayerNameUnitDescriptor(ARMODBaseUnit _target) : base(_target)
        {
        }
        ...
        protected override EditorTexture DefaultIcon()
        {
            ...
            return EditorTexture.Single(
                AssetDatabase.LoadAssetAtPath<Texture>(
                    "Packages/com.phantomsxr.visualscriptingextension/Editor/Icons/textfield.png"));
        }
        ...
        {
            return "Synced the player name to all client";
        }
        ...
        protected override void DefinedPort(IUnitPort _port, UnitPortDescription _description)
        {
            ...
            {
                case "Name":
                    _description.summary = "The new player name.";
                    break;
                case "Properties":
