...
{
    [Descriptor(typeof(IsServerUnit))]
    public class IsServerUnitDescriptor: ARMODBaseUnitDescriptor
    {
        public IsServerUnitDescriptor(ARMODBaseUnit _target) : base(_target)
        {
        }
        ...
        protected override EditorTexture DefaultIcon()
        {
            return EditorTexture.Single(
                AssetDatabase.LoadAssetAtPath<Texture>(
                    "Packages/com.phantomsxr.visualscriptingextension/Editor/Icons/IsServer.png"));
        }
        ...
        protected override void DefinedPort(IUnitPort _port, UnitPortDescription _description)
        {
            ...
            switch (_port.key)
            {
                case "Target":
                    ...
                    break;
                case "Result":
                    _description.summary = "Return true or false. True current user is server, if False otherwise.";
                    break;
            }
        }
    }
