...
{
    [Descriptor(typeof(GetLocalPlayerUnit))]
    public class GetLocalPlayerDescriptor : ARMODBaseWithResultUnitDescriptor
    {
        public GetLocalPlayerDescriptor(ARMODBaseWithResultUnit _target) : base(_target)
        {
        }

        protected override string DefinedSummary()
        {
            return "Access the local player game object.";
        }
        ...
        protected override void DefinedPort(IUnitPort _port, UnitPortDescription _description)
        {
            ...
            {
                case "LocalPlayer":
                    _description.summary = "The local player game object.";
                    break;
            }
        }
    }
